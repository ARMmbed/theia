 ...
 *--------------------------------------------------------------------------------------------*/
// Based on: https://hghub.com/Microsoft/vscode/blob/dd3e2d94f81139f9d18ba15a24c16c6061880b93/extensions/hg/src/askpass-main.ts.
...
// 3. `Username`/`Password`.
// 4. `for`.
// 5. The host. For example: `https://hghub.com`.
...
function main(argv: string[]): void {
    ...
    const hgRequest = argv[2];
    const hgHost = argv[4].substring(1, argv[4].length - 2);
    ...
    req.write(JSON.stringify({ hgRequest, hgHost }));
    req.end();
}
